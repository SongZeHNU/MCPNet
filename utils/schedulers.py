...
def get_scheduler(optimizer, args):
    ...
    if args.scheduler == 'step':
        ...
        scheduler = WarmupCosineSchedule(optimizer, warmup_steps=args.warmup_epochs, t_total=args.epochs)
...
class WarmupCosineSchedule(LambdaLR):
    ...
    """
    def __init__(self, optimizer, warmup_steps=5, t_total=200, cycles=.5, last_epoch=-1):
